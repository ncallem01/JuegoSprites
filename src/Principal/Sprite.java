...
public class Sprite {
	...
	public boolean colisiona(Sprite otro) {
		boolean colisionX = posX < otro.posX ? 
				(posX+ancho >= otro.posX+80) : 
					(otro.posX+otro.ancho >=posX+80);
				
		boolean colisionY = posY < otro.posY ? 
				(posY+alto >= otro.posY+80) : 
					(otro.posY+otro.alto >=posY+80);
	 ...
	 * @return
	 */
	public boolean colisionaMuneco(Sprite otro) {
		boolean colisionX = posX < otro.posX ? 
				(posX+ancho >= otro.posX+180) : 
					(otro.posX+otro.ancho >=posX+180);
				
		boolean colisionY = posY < otro.posY ? 
				(posY+alto >= otro.posY+180) : 
					(otro.posY+otro.alto >=posY+180);
	 ...
	 * @return
	 */
	public boolean colisionaJuego(Sprite otro) {
		boolean colisionX = posX < otro.posX ? 
				(posX+ancho >= otro.posX+20) : 
					(otro.posX+otro.ancho >=posX+20);
	...
	public boolean hagoclick(MouseEvent e) {
		return e.getX() > posX && e.getX() < posX + ancho && e.getY() > posY && e.getY() < posY + alto;
	}
